...
cpdef np.ndarray update_positions(np.ndarray pair, np.ndarray positions):
...
cpdef np.ndarray update_Q(np.ndarray pair, np.ndarray Q):
...
cpdef np.ndarray update_pairs(np.ndarray pairs, np.ndarray positions, np.ndarray Q, np.ndarray features):
...
cpdef np.ndarray update_face(np.ndarray pair, np.ndarray face):
    ...
    """
    cdef long v1, v2, i
    cdef np.ndarray rows, rows_v1, rows_v2
...
cpdef np.ndarray update_features(np.ndarray pair, np.ndarray features):
...
cpdef np.ndarray sort_by_error(np.ndarray pairs):
